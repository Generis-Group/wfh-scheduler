      ...
      {open && position && typeof document !== "undefined"
        ? createPortal(
            <div
              ref={menuRef}
              role="menu"
              className="fixed z-[70] overflow-y-auto overscroll-contain rounded-xl bg-white p-1.5 text-sm shadow-[0_18px_42px_rgba(15,23,42,0.18)] ring-1 ring-border dark:bg-card dark:ring-border"
              style={{
                left: position.left,
                top: position.top,
